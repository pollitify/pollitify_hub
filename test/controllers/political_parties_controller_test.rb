...
class PoliticalPartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create political_party" do
    assert_difference("PoliticalParty.count") do
      post political_parties_url, params: { political_party: { fid: @political_party.fid, name: @political_party.name, url: @political_party.url } }
    end
  ...
  test "should update political_party" do
    patch political_party_url(@political_party), params: { political_party: { fid: @political_party.fid, name: @political_party.name, url: @political_party.url } }
