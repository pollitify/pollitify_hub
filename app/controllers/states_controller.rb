class StatesController < ApplicationController
  ...
  private
    ...
    def state_params
      params.expect(state: [ :name, :abbreviation, :fid, :population, :congressional_district_count, :wikipedia_congressional_district_url, :wikipedia_congressional_district_map_url, :counties_count, :townships_count ])
    end
end
